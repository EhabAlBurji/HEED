...
import { GripVertical, Link2, Pause, Play, Square, Clock, Calendar } from "lucide-react";
...
// Dense kanban card — single row, ~40-48px tall, info on one line.
// Action buttons reveal on hover. Priority shown via a thin left stripe + dot.
...
export function KanbanCard({ task, onOpen }: { task: Task; onOpen?: (id: string) => void }) {
  ...
  return (
    ...
    >
      ...
      {/* Body — clickable to open detail drawer */}
      <button
      ...
      >
        ...
        {/* Inline meta — only shown if present, compact */}
      ...
      {/* Timer controls — appear on hover, OR shown when active */}
      {!isDone && (
        <div className={cn(
